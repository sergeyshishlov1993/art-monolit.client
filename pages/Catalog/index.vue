...
useHead({
  ...
  meta: [
    ...
    },
    {
      name: "keywords",
      content:
        " одинарные двойные памятники запорожье, памятинки для военых, заказать памятник в запорожье, памятник под ключ заказать в запорожье, одинарный памятник запорожье, двойной памятник запорожье ",
    },
  ],
});
</script>
